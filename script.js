...
// размер видимой части элемента холста
...
document.getElementById("save_image").onclick = function(){
    ...
    // сохранение холста заднего фона
    ctx_save.drawImage(cnv_bg, 0, 0, cnv.width, cnv.height);
    // сохранение переднего фона
...
// ждём событие клип по кнопке очистки холста
